...
function App() {
 ...
 const submitInventoryRecord = () => {
   ...
   /*
     We are NOT writing to OneDrive yet.
     This will eventually create the VIQ JSON
     record and place it into:
     OneDrive / VIQ / pending
   */
   console.log("Inventory record ready:", {
     location: locationBarcode,
     equipment: equipmentBarcode,
     status: "PENDING",
   });
